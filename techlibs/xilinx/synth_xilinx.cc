		...
		if (check_label("map_memory")) {
			...
			if (help_mode) {
				...
				if (family == "xcv" || family == "xcve") {
					params += " -lib +/xilinx/lutram_xcv.txt";
					params += " -D IS_VIRTEX";
					params += " -lib +/xilinx/bram_xcv.txt";
				} else if (family == "xc2v" || family == "xc2vp") {
					params += " -lib +/xilinx/lutram_xcv.txt";
					params += " -D IS_VIRTEX2";
					params += " -lib +/xilinx/bram_xc2v.txt";
					...
					params += " -lib +/xilinx/lutram_xc5v.txt";
					params += " -lib +/xilinx/bram_xc2v.txt";
					params += " -D HAS_BE";
					params += " -D HAS_SIZE_9";
					params += " -D HAS_SDP";
